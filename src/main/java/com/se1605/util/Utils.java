...
import com.se1605.config.ServerConfiguration;
...
public class Utils {
     ...
     */
    public static String uploadFile(String documentStoragePath, MultipartFile content, String url, Boolean rewrite, String key) {
        String filePath;
        try {
            String fileName;
            ...
            if (StringUtils.isEmpty(url)) {
                ...
                try (InputStream inputStream = content.getInputStream()) {
                    filePath = uploadFileInternal(inputStream, documentStoragePath, fileName, rewrite, key);
                } catch (Exception ex) {
     ...
     * @throws IOException
     */
    public static String uploadFileInternal(InputStream uploadedInputStream, String documentStoragePath, String fileName, boolean rewrite, String key) throws IOException, NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException {
        ...
        if (rewrite) {
            ...
            fileEncrypterDecrypter.encrypt(uploadedInputStream, filePath);
...
//            Files.copy(uploadedInputStream, file.toPath(), StandardCopyOption.REPLACE_EXISTING);
            ...
            FileEncrypterDecrypter fileEncrypterDecrypter = new FileEncrypterDecrypter(key);
            fileEncrypterDecrypter.encrypt((FileInputStream) uploadedInputStream, filePath);
